...
message("paste function(id):")
paste(id, sep=", ")
cat("f(g(x))-Using paste function: ", paste(id))
message("g(f(x))-Using cat function: ")
paste(cat(id))
```

**2j.Difference between cat and paste ** How would you determine the difference between 
...
```{R Part 3 Instructions, include=FALSE}
